...
function ElvUI_EltreumUI:Configtable()
	...
	E.Options.args.ElvUI_EltreumUI = {
		...
		args = {
					...
					resetlayout = {
						...
						args = {
							...
							header2 = {
								order = 3,
								type = "description",
								name = L["Reinstall Healer Layout"],
								width = 'full',
								image = function() return 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', 3240, 1 end,
							},
							resethealer = {
							...
							header3 = {
								order = 5,
								type = "description",
								name = L["Reinstall Eltruism Datatext"],
								width = 'full',
								image = function() return 'Interface\\AddOns\\ElvUI_EltreumUI\\Media\\Textures\\EltreumHeader', 3240, 1 end,
							},
							resetoradddatatext = {
					...
					general = {
						...
						args = {
							...
							enable = {
								...
								set = function(_, value) E.db.ElvUI_EltreumUI.borders.borders = value ElvUI_EltreumUI:ShowHideBorders() ElvUI_EltreumUI:Borders() E:StaticPopup_Show('CONFIG_RL') end,
							},
							enableautoadjust = {
								type = 'toggle',
					...
					ufborders = {
						...
						args = {
							...
							player = {
								...
								args = {
									...
									borderxplayer = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.playerborder or not E.db.unitframe.units.player.enable end,
									...
									borderxcastplayer = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.playercastborder or not E.db.unitframe.units.player.castbar.enable end,
							...
							target = {
								...
								args = {
									...
									borderxtarget = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.targetborder or not E.db.unitframe.units.target.enable end,
									...
									borderxcasttarget = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.targetcastborder or not E.db.unitframe.units.target.castbar.enable end,
							...
							targettarget = {
								...
								args = {
									...
									borderxtargettarget = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.targettargetborder or not E.db.unitframe.units.targettarget.enable end,
							...
							party = {
								...
								args = {
									...
									borderxparty = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.partyborders or not E.db.unitframe.units.party.enable end,
							...
							raid1 = {
								...
								args = {
									barraid = {
										...
										order = 44,
										width = "full",
										disabled = function() return (not E.db.ElvUI_EltreumUI.borders.borders and not E.db.unitframe.units.raid1.enable) or (not E.db.ElvUI_EltreumUI.borders.borders and not E.private.unitframe.disabledBlizzardFrames.raid) end,
									...
									borderxraid = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return (not E.db.ElvUI_EltreumUI.borders.raidborders and not E.db.unitframe.units.raid1.enable) or (not E.db.ElvUI_EltreumUI.borders.raidborders and not E.private.unitframe.disabledBlizzardFrames.raid) end,
							...
							raid2 = {
								...
								args = {
									...
									borderxraid2 = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.raid2borders or not E.db.unitframe.units.raid2.enable end,
							...
							raid3 = {
								...
								args = {
									...
									borderxraid3 = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.raid40borders or not E.db.unitframe.units.raid3.enable end,
							...
							focus = {
								...
								type = 'group',
								--inline = true,
								disabled = function() return not E.db.unitframe.units.focus.enable or not E.db.ElvUI_EltreumUI.borders.borders end,
								name = L["Focus Border"],
								hidden = E.Classic,
								childGroups = "tab",
								width = 'full',
								args = {
									...
									borderfocussize = {
										...
										width = "full",
										hidden = E.Classic,
										disabled = function() return E.db.ElvUI_EltreumUI.borders.borderautoadjust or not E.private.unitframe.enable end,
									...
									borderxfocus = {
										...
										width = "full",
										hidden = E.Classic,
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.borders or not E.db.unitframe.units.focus.enable or not E.db.ElvUI_EltreumUI.borders.focusborder end,
									...
									borderxcastfocus = {
										...
										width = "full",
										hidden = E.Classic,
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.focuscastborder or not E.db.unitframe.units.focus.enable or not E.db.unitframe.units.focus.castbar.enable end,
							...
							focustarget = {
								...
								args = {
									...
									borderxfocustarget = {
										...
										width = "full",
										hidden = E.Classic,
										disabled = function() return E.db.ElvUI_EltreumUI.borders.borderautoadjust or not E.private.unitframe.enable or not E.db.unitframe.units.focustarget.enable or not E.db.ElvUI_EltreumUI.borders.focustargetborder end,
							...
							boss = {
								...
								type = 'group',
								--inline = true,
								disabled = function() return not E.db.unitframe.units.boss.enable or not E.db.ElvUI_EltreumUI.borders.borders end,
								name = L["Boss Border"],
								hidden = not (E.Retail or E.Wrath),
								childGroups = "tab",
								width = 'full',
								args = {
									...
									borderbosssize = {
										...
										width = "full",
										hidden = not (E.Retail or E.Wrath),
										disabled = function() return E.db.ElvUI_EltreumUI.borders.borderautoadjust or not E.db.ElvUI_EltreumUI.borders.bossborder or not E.private.unitframe.enable end,
									...
									borderxboss = {
										...
										width = "full",
										hidden = not (E.Retail or E.Wrath),
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.bossborder or not E.db.unitframe.units.boss.enable end,
							...
							pet = {
								...
								args = {
									...
									borderpetsize = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return E.db.ElvUI_EltreumUI.borders.borderautoadjust or not E.db.ElvUI_EltreumUI.borders.petborder or not E.db.unitframe.units.pet.enable end,
									...
									borderxpet = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.petborder or not E.db.unitframe.units.pet.enable end,
					...
					npborder = {
						...
						args = {
							...
							borderpowerbarsize = {
								...
								step = 0.1,
								width = "full",
								disabled = function() return not E.db.ElvUI_EltreumUI.borders.powerbarborder or not E.private.ElvUI_EltreumUI.nameplatepower end,
							...
							chat = {
								...
								args = {
									...
									borderchatsize = {
										...
										step = 0.1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.borders.borders or not E.db.ElvUI_EltreumUI.borders.chatborder end,
					...
					cursorposition = {
						...
						args = {
							nicegap4 = {
								order = 21,
								type = "description",
								name = L["Cursor Position"]..'|cffff0000('..L["Requires a Reload"]..")|r",
								width = 'full',
							},
							coooldownx = {
								type = 'range',
			...
			gradient = {
				type = 'group',
				name = E:TextGradient(L["Gradient Colors"], 0.50, 0.70, 1, 0.67, 0.95, 1),
				order = 85,
				childGroups = "tab",
			...
			nameplates = {
				type = 'group',
				name = E:TextGradient(L["Nameplates"], 0.50, 0.70, 1, 0.67, 0.95, 1),
				order = 85,
				childGroups = "tab",
							...
							enable = {
								...
								args = {
									enableeliterareicons = {
										order = 2,
										type = 'toggle',
										name = L["Enable replacing Elite/Rare Icons"].." - |cffFF0000"..L["Requires ElvUI Nameplate Elite Icon"].."|r",
										desc = L["Adds different Rare/Elite Icons"],
										width = 'full',
										get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.enable end,
										set = function(_, value) E.db.ElvUI_EltreumUI.nameplates.classification.enable = value ElvUI_EltreumUI:NPClassificatioNIcon() end,
									},
								}
							},
							boss = {
								...
								args = {
									...
									bosscolor = {
										...
										hasAlpha = false,
										width = "full",
										disabled = function() return (not E.db.ElvUI_EltreumUI.nameplates.classification.enable) end,
										get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.bossR, E.db.ElvUI_EltreumUI.nameplates.classification.bossG, E.db.ElvUI_EltreumUI.nameplates.classification.bossB, 1, P.ElvUI_EltreumUI.nameplates.classification.bossR, P.ElvUI_EltreumUI.nameplates.classification.bossG, P.ElvUI_EltreumUI.nameplates.classification.bossB, 1 end,
										set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.nameplates.classification.bossR, E.db.ElvUI_EltreumUI.nameplates.classification.bossG, E.db.ElvUI_EltreumUI.nameplates.classification.bossB = r, g, b end,
									},
									bossiconpick = {
										order = 5,
										type = 'select',
										...
										style = 'radio',
										disabled = function() return not E.db.ElvUI_EltreumUI.nameplates.classification.enable end,
										get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.icontypeboss end,
										set = function(_,value) E.db.ElvUI_EltreumUI.nameplates.classification.icontypeboss = value end,
									},
								}
							},
							elite = {
								...
								args = {
									...
									elitecolor = {
										...
										width = "full",
										disabled = function() return (not E.db.ElvUI_EltreumUI.nameplates.classification.enable) end,
										get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.eliteR, E.db.ElvUI_EltreumUI.nameplates.classification.eliteG, E.db.ElvUI_EltreumUI.nameplates.classification.eliteB, 1, P.ElvUI_EltreumUI.nameplates.classification.eliteR, P.ElvUI_EltreumUI.nameplates.classification.eliteG, P.ElvUI_EltreumUI.nameplates.classification.eliteB, 1 end,
										set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.nameplates.classification.eliteR, E.db.ElvUI_EltreumUI.nameplates.classification.eliteG, E.db.ElvUI_EltreumUI.nameplates.classification.eliteB = r, g, b end,
									},
									eliteiconpick = {
										order = 8,
										type = 'select',
										...
										style = 'radio',
										disabled = function() return not E.db.ElvUI_EltreumUI.nameplates.classification.enable end,
										get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.icontypeelite end,
										set = function(_,value) E.db.ElvUI_EltreumUI.nameplates.classification.icontypeelite = value end,
									},
								}
							},
							rare = {
								...
								args = {
									...
									rarecolor = {
										...
										width = "full",
										disabled = function() return (not E.db.ElvUI_EltreumUI.nameplates.classification.enable) end,
										get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.rareR, E.db.ElvUI_EltreumUI.nameplates.classification.rareG, E.db.ElvUI_EltreumUI.nameplates.classification.rareB, 1, P.ElvUI_EltreumUI.nameplates.classification.rareR, P.ElvUI_EltreumUI.nameplates.classification.rareG, P.ElvUI_EltreumUI.nameplates.classification.rareB, 1 end,
										set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.nameplates.classification.rareR, E.db.ElvUI_EltreumUI.nameplates.classification.rareG, E.db.ElvUI_EltreumUI.nameplates.classification.rareB = r, g, b end,
									},
									rareiconpick = {
										order = 11,
										type = 'select',
							...
							rareelite = {
								...
								args = {
									...
									rareelitecolor = {
										order = 13,
										type = 'color',
										name = L["Rare Elite Color"],
										hasAlpha = false,
										width = "full",
										disabled = function() return (not E.db.ElvUI_EltreumUI.nameplates.classification.enable) end,
										get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.rareeliteR, E.db.ElvUI_EltreumUI.nameplates.classification.rareeliteG, E.db.ElvUI_EltreumUI.nameplates.classification.rareeliteB, 1, P.ElvUI_EltreumUI.nameplates.classification.rareeliteR, P.ElvUI_EltreumUI.nameplates.classification.rareeliteG, P.ElvUI_EltreumUI.nameplates.classification.rareeliteB, 1 end,
										set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.nameplates.classification.rareeliteR, E.db.ElvUI_EltreumUI.nameplates.classification.rareeliteG, E.db.ElvUI_EltreumUI.nameplates.classification.rareeliteB = r, g, b end,
									},
									rareeliteiconpick = {
										order = 14,
										type = 'select',
										name = L["Rare Elite Icon"],
										values = {
											["TYPE1"] = E:TextureString('Interface\\Addons\\ElvUI_EltreumUI\\Media\\Textures\\Nameplates\\star',':20:20'),
											["TYPE2"] = E:TextureString('Interface\\Addons\\ElvUI_EltreumUI\\Media\\Textures\\Nameplates\\star2',':20:20'),
											["TYPE3"] = E:TextureString('Interface\\Addons\\ElvUI_EltreumUI\\Media\\Textures\\Nameplates\\star3',':20:20'),
										...
										style = 'radio',
										disabled = function() return not E.db.ElvUI_EltreumUI.nameplates.classification.enable end,
										get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.icontyperareelite end,
										set = function(_,value) E.db.ElvUI_EltreumUI.nameplates.classification.icontyperareelite = value end,
									},
								}
							},
							custom = {
									...
									customicons = {
										...
										args = {
											bossicon = {
												...
												width = 'full',
												disabled = function() return not E.db.ElvUI_EltreumUI.nameplates.classification.enable or E.db.ElvUI_EltreumUI.nameplates.classification.icontypeboss ~= 'CUSTOM' end,
												get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.customboss end,
												set = function(_, value) E.db.ElvUI_EltreumUI.nameplates.classification.customboss = value end,
											},
											eliteicon = {
												order = 165,
												type = 'input',
												...
												desc = L["Example: "].."mytexture.tga or mytexture or mytexture.jpg",
												width = 'full',
												disabled = function() return not E.db.ElvUI_EltreumUI.nameplates.classification.enable or E.db.ElvUI_EltreumUI.nameplates.classification.icontypeelite ~= 'CUSTOM' end,
												get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.customelite end,
												set = function(_, value) E.db.ElvUI_EltreumUI.nameplates.classification.customelite = value end,
											},
											rareicon = {
												order = 166,
												type = 'input',
												...
												desc = L["Example: "].."mytexture.tga or mytexture or mytexture.jpg",
												width = 'full',
												disabled = function() return not E.db.ElvUI_EltreumUI.nameplates.classification.enable or E.db.ElvUI_EltreumUI.nameplates.classification.icontyperare ~= 'CUSTOM' end,
												get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.customrare end,
												set = function(_, value) E.db.ElvUI_EltreumUI.nameplates.classification.customrare = value end,
											},
											rareeliteicon = {
												order = 167,
												type = 'input',
												...
												desc = L["Example: "].."mytexture.tga or mytexture or mytexture.jpg",
												width = 'full',
												disabled = function() return not E.db.ElvUI_EltreumUI.nameplates.classification.enable or E.db.ElvUI_EltreumUI.nameplates.classification.icontyperareelite ~= 'CUSTOM' end,
												get = function() return E.db.ElvUI_EltreumUI.nameplates.classification.customrareelite end,
												set = function(_, value) E.db.ElvUI_EltreumUI.nameplates.classification.customrareelite = value end,
											},
										},
									},
								}
					...
					instances = {
						...
						args = {
							...
							instancecolor = {
								...
								hasAlpha = false,
								width = "full",
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor) end,
							...
							unifycolors = {
								type = 'toggle',
								name = L["Difficulty Specific Colors"],
								desc = L["Use different colors per Difficulty"],
								order = 4,
								width = "full",
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.difficultycolors end,
								set = function(_, value) E.db.ElvUI_EltreumUI.skins.instances.difficultycolors = value E:StaticPopup_Show('CONFIG_RL') end,
							},
							instanceclasscolor = {
								type = 'toggle',
								name = L["Use Class Colors"],
								...
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.classcolor end,
								set = function(_, value) E.db.ElvUI_EltreumUI.skins.instances.classcolor = value E:StaticPopup_Show('CONFIG_RL') end,
							},
							instancecolorgradient = {
								...
								order = 6,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.gradient end,
								set = function(_, value) E.db.ElvUI_EltreumUI.skins.instances.gradient = value E:StaticPopup_Show('CONFIG_RL') end,
							},
							instancecolorgradientoffsetred = {
								type = 'range',
								name = L["Red"],
								order = 8,
								min = -1,
								...
								step = 0.01,
								desc = L["This is how much the color will gain or lose this value"],
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or not E.db.ElvUI_EltreumUI.skins.instances.gradient or E.db.ElvUI_EltreumUI.skins.instances.classcolor) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.redoffset end,
								set = function(_, value) E.db.ElvUI_EltreumUI.skins.instances.redoffset = value E:StaticPopup_Show('CONFIG_RL') end,
							},
							instancecolorgradientoffsetgreen = {
								type = 'range',
								name = L["Green"],
								order = 8,
								min = -1,
								...
								desc = L["This is how much the color will gain or lose this value"],
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or not E.db.ElvUI_EltreumUI.skins.instances.gradient or E.db.ElvUI_EltreumUI.skins.instances.classcolor) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.greenoffset end,
								set = function(_, value) E.db.ElvUI_EltreumUI.skins.instances.greenoffset = value E:StaticPopup_Show('CONFIG_RL') end,
							},
							instancecolorgradientoffsetblue = {
								type = 'range',
								name = L["Blue"],
								order = 8,
								min = -1,
								...
								desc = L["This is how much the color will gain or lose this value"],
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or not E.db.ElvUI_EltreumUI.skins.instances.gradient or E.db.ElvUI_EltreumUI.skins.instances.classcolor) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.blueoffset end,
								set = function(_, value) E.db.ElvUI_EltreumUI.skins.instances.blueoffset = value E:StaticPopup_Show('CONFIG_RL') end,
							},
							instancefontsize = {
								type = 'range',
								name = L["Font Size"],
							...
							DungeonNormalColor = {
								...
								hasAlpha = false,
								--width = "full",
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.DungeonNormalColor.r, E.db.ElvUI_EltreumUI.skins.instances.DungeonNormalColor.g, E.db.ElvUI_EltreumUI.skins.instances.DungeonNormalColor.b, 1, P.ElvUI_EltreumUI.skins.instances.DungeonNormalColor.r, P.ElvUI_EltreumUI.skins.instances.DungeonNormalColor.g, P.ElvUI_EltreumUI.skins.instances.DungeonNormalColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.DungeonNormalColor.r, E.db.ElvUI_EltreumUI.skins.instances.DungeonNormalColor.g, E.db.ElvUI_EltreumUI.skins.instances.DungeonNormalColor.b = r, g, b end,
							},
							DungeonNormal = {
								order = 81,
								type = 'input',
							...
							DungeonHeroicColor = {
								...
								hidden = E.Classic,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.DungeonHeroicColor.r, E.db.ElvUI_EltreumUI.skins.instances.DungeonHeroicColor.g, E.db.ElvUI_EltreumUI.skins.instances.DungeonHeroicColor.b, 1, P.ElvUI_EltreumUI.skins.instances.DungeonHeroicColor.r, P.ElvUI_EltreumUI.skins.instances.DungeonHeroicColor.g, P.ElvUI_EltreumUI.skins.instances.DungeonHeroicColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.DungeonHeroicColor.r, E.db.ElvUI_EltreumUI.skins.instances.DungeonHeroicColor.g, E.db.ElvUI_EltreumUI.skins.instances.DungeonHeroicColor.b = r, g, b end,
							},
							DungeonHeroic = {
								order = 84,
								type = 'input',
							...
							DungeonTimewalkingColor = {
								...
								hidden = not E.Retail,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.DungeonTimewalkerColor.r, E.db.ElvUI_EltreumUI.skins.instances.DungeonTimewalkerColor.g, E.db.ElvUI_EltreumUI.skins.instances.DungeonTimewalkerColor.b, 1, P.ElvUI_EltreumUI.skins.instances.DungeonTimewalkerColor.r, P.ElvUI_EltreumUI.skins.instances.DungeonTimewalkerColor.g, P.ElvUI_EltreumUI.skins.instances.DungeonTimewalkerColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.DungeonTimewalkerColor.r, E.db.ElvUI_EltreumUI.skins.instances.DungeonTimewalkerColor.g, E.db.ElvUI_EltreumUI.skins.instances.DungeonTimewalkerColor.b = r, g, b end,
							},
							DungeonTimwalking = {
								order = 87,
								type = 'input',
							...
							DungeonMzeroColor = {
								...
								hidden = not E.Retail,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicColor.r, E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicColor.g, E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicColor.b, 1, P.ElvUI_EltreumUI.skins.instances.DungeonMythicColor.r, P.ElvUI_EltreumUI.skins.instances.DungeonMythicColor.g, P.ElvUI_EltreumUI.skins.instances.DungeonMythicColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicColor.r, E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicColor.g, E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicColor.b = r, g, b end,
							},
							DungeonMzero = {
								order = 90,
								type = 'input',
							...
							DungeonMplusColor = {
								...
								hidden = not E.Retail,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicPlusColor.r, E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicPlusColor.g, E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicPlusColor.b, 1, P.ElvUI_EltreumUI.skins.instances.DungeonMythicPlusColor.r, P.ElvUI_EltreumUI.skins.instances.DungeonMythicPlusColor.g, P.ElvUI_EltreumUI.skins.instances.DungeonMythicPlusColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicPlusColor.r, E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicPlusColor.g, E.db.ElvUI_EltreumUI.skins.instances.DungeonMythicPlusColor.b = r, g, b end,
							},
							DungeonMplus = {
								order = 93,
								type = 'input',
							...
							RaidColor = {
								...
								--hidden = not E.Retail,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.RaidColor.r, E.db.ElvUI_EltreumUI.skins.instances.RaidColor.g, E.db.ElvUI_EltreumUI.skins.instances.RaidColor.b, 1, P.ElvUI_EltreumUI.skins.instances.RaidColor.r, P.ElvUI_EltreumUI.skins.instances.RaidColor.g, P.ElvUI_EltreumUI.skins.instances.RaidColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.RaidColor.r, E.db.ElvUI_EltreumUI.skins.instances.RaidColor.g, E.db.ElvUI_EltreumUI.skins.instances.RaidColor.b = r, g, b end,
							},
							Raid = {
								order = 96,
								type = 'input',
							...
							Raid10Color = {
								...
								--hidden = not E.Retail,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.Raid10Color.r, E.db.ElvUI_EltreumUI.skins.instances.Raid10Color.g, E.db.ElvUI_EltreumUI.skins.instances.Raid10Color.b, 1, P.ElvUI_EltreumUI.skins.instances.Raid10Color.r, P.ElvUI_EltreumUI.skins.instances.Raid10Color.g, P.ElvUI_EltreumUI.skins.instances.Raid10Color.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.Raid10Color.r, E.db.ElvUI_EltreumUI.skins.instances.Raid10Color.g, E.db.ElvUI_EltreumUI.skins.instances.Raid10Color.b = r, g, b end,
							},
							Raid10 = {
								order = 99,
								type = 'input',
							...
							Raid25Color = {
								...
								--hidden = not E.Retail,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.Raid25Color.r, E.db.ElvUI_EltreumUI.skins.instances.Raid25Color.g, E.db.ElvUI_EltreumUI.skins.instances.Raid25Color.b, 1, P.ElvUI_EltreumUI.skins.instances.Raid25Color.r, P.ElvUI_EltreumUI.skins.instances.Raid25Color.g, P.ElvUI_EltreumUI.skins.instances.Raid25Color.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.Raid25Color.r, E.db.ElvUI_EltreumUI.skins.instances.Raid25Color.g, E.db.ElvUI_EltreumUI.skins.instances.Raid25Color.b = r, g, b end,
							},
							Raid25 = {
								order = 102,
								type = 'input',
							...
							RaidHeroicColor = {
								...
								hidden = E.Classic or E.Wrath,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.RaidHeroicColor.r, E.db.ElvUI_EltreumUI.skins.instances.RaidHeroicColor.g, E.db.ElvUI_EltreumUI.skins.instances.RaidHeroicColor.b, 1, P.ElvUI_EltreumUI.skins.instances.RaidHeroicColor.r, P.ElvUI_EltreumUI.skins.instances.RaidHeroicColor.g, P.ElvUI_EltreumUI.skins.instances.RaidHeroicColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.RaidHeroicColor.r, E.db.ElvUI_EltreumUI.skins.instances.RaidHeroicColor.g, E.db.ElvUI_EltreumUI.skins.instances.RaidHeroicColor.b = r, g, b end,
							},
							RaidHeroic = {
								order = 105,
								type = 'input',
							...
							RaidHeroic25Color = {
								...
								hidden = E.Classic,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.Raid25HeroicColor.r, E.db.ElvUI_EltreumUI.skins.instances.Raid25HeroicColor.g, E.db.ElvUI_EltreumUI.skins.instances.Raid25HeroicColor.b, 1, P.ElvUI_EltreumUI.skins.instances.Raid25HeroicColor.r, P.ElvUI_EltreumUI.skins.instances.Raid25HeroicColor.g, P.ElvUI_EltreumUI.skins.instances.Raid25HeroicColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.Raid25HeroicColor.r, E.db.ElvUI_EltreumUI.skins.instances.Raid25HeroicColor.g, E.db.ElvUI_EltreumUI.skins.instances.Raid25HeroicColor.b = r, g, b end,
							},
							RaidHeroic25 = {
								order = 108,
								type = 'input',
							...
							RaidHeroic10Color = {
								...
								hidden = E.Classic,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.Raid10HeroicColor.r, E.db.ElvUI_EltreumUI.skins.instances.Raid10HeroicColor.g, E.db.ElvUI_EltreumUI.skins.instances.Raid10HeroicColor.b, 1, P.ElvUI_EltreumUI.skins.instances.Raid10HeroicColor.r, P.ElvUI_EltreumUI.skins.instances.Raid10HeroicColor.g, P.ElvUI_EltreumUI.skins.instances.Raid10HeroicColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.Raid10HeroicColor.r, E.db.ElvUI_EltreumUI.skins.instances.Raid10HeroicColor.g, E.db.ElvUI_EltreumUI.skins.instances.Raid10HeroicColor.b = r, g, b end,
							},
							RaidHeroic10 = {
								order = 111,
								type = 'input',
							...
							RaidLFRColor = {
								...
								hidden = not E.Retail,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.RaidLFRColor.r, E.db.ElvUI_EltreumUI.skins.instances.RaidLFRColor.g, E.db.ElvUI_EltreumUI.skins.instances.RaidLFRColor.b, 1, P.ElvUI_EltreumUI.skins.instances.RaidLFRColor.r, P.ElvUI_EltreumUI.skins.instances.RaidLFRColor.g, P.ElvUI_EltreumUI.skins.instances.RaidLFRColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.RaidLFRColor.r, E.db.ElvUI_EltreumUI.skins.instances.RaidLFRColor.g, E.db.ElvUI_EltreumUI.skins.instances.RaidLFRColor.b = r, g, b end,
							},
							RaidLFR = {
								order = 114,
								type = 'input',
							...
							RaidMythicColor = {
								...
								hidden = not E.Retail,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.MythicRaidColor.r, E.db.ElvUI_EltreumUI.skins.instances.MythicRaidColor.g, E.db.ElvUI_EltreumUI.skins.instances.MythicRaidColor.b, 1, P.ElvUI_EltreumUI.skins.instances.MythicRaidColor.r, P.ElvUI_EltreumUI.skins.instances.MythicRaidColor.g, P.ElvUI_EltreumUI.skins.instances.MythicRaidColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.MythicRaidColor.r, E.db.ElvUI_EltreumUI.skins.instances.MythicRaidColor.g, E.db.ElvUI_EltreumUI.skins.instances.MythicRaidColor.b = r, g, b end,
							},
							RaidMythic = {
								order = 117,
								type = 'input',
							...
							RaidTimewalkingColor = {
								...
								hidden = not E.Retail,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.RaidTimewalkerColor.r, E.db.ElvUI_EltreumUI.skins.instances.RaidTimewalkerColor.g, E.db.ElvUI_EltreumUI.skins.instances.RaidTimewalkerColor.b, 1, P.ElvUI_EltreumUI.skins.instances.RaidTimewalkerColor.r, P.ElvUI_EltreumUI.skins.instances.RaidTimewalkerColor.g, P.ElvUI_EltreumUI.skins.instances.RaidTimewalkerColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.RaidTimewalkerColor.r, E.db.ElvUI_EltreumUI.skins.instances.RaidTimewalkerColor.g, E.db.ElvUI_EltreumUI.skins.instances.RaidTimewalkerColor.b = r, g, b end,
							},
							RaidTimewalking = {
								order = 120,
								type = 'input',
							...
							guildColor = {
								...
								hidden = not E.Retail,
								disabled = function() return (not E.db.ElvUI_EltreumUI.skins.instances.enable or E.db.ElvUI_EltreumUI.skins.instances.classcolor or not E.db.ElvUI_EltreumUI.skins.instances.difficultycolors) end,
								get = function() return E.db.ElvUI_EltreumUI.skins.instances.guildColor.r, E.db.ElvUI_EltreumUI.skins.instances.guildColor.g, E.db.ElvUI_EltreumUI.skins.instances.guildColor.b, 1, P.ElvUI_EltreumUI.skins.instances.guildColor.r, P.ElvUI_EltreumUI.skins.instances.guildColor.g, P.ElvUI_EltreumUI.skins.instances.guildColor.b, 1 end,
								set = function(_, r, g, b, a) E.db.ElvUI_EltreumUI.skins.instances.guildColor.r, E.db.ElvUI_EltreumUI.skins.instances.guildColor.g, E.db.ElvUI_EltreumUI.skins.instances.guildColor.b = r, g, b end,
							},
							Guild = {
								order = 123,
								type = 'input',
					...
					questitem = {
						...
						args = {
							...
							questitembarkeybind = {
								...
								get = function() return E.db.ElvUI_EltreumUI.quests.showkeybind end,
								set = function(_, value) E.db.ElvUI_EltreumUI.quests.showkeybind = value E:StaticPopup_Show('CONFIG_RL') end,
							},
							questiconsizes = {
								order = 78,
								type = "description",
							...
							blizzard = {
								...
								args = {
									...
									bankscale = {
										...
										step = 0.01,
										width = 'double',
										get = function() return E.db.ElvUI_EltreumUI.otherstuff.bankscale end,
										set = function(_, value) E.db.ElvUI_EltreumUI.otherstuff.bankscale = value
											if _G["ElvUI_BankContainerFrame"] then
												_G["ElvUI_BankContainerFrame"]:SetScale(value)
											end
										end,
									},
									header79745 = {
							...
							altpower = {
								...
								args = {
									...
									gradientaltpower = {
										order = 74,
										type = "description",
										name = L["Add a gradient color to the Alt Power Bar"],
										width = "full",
										hidden = not E.Retail,
									},
									gradientAltPowerenable = {
										order = 75,
										type = 'toggle',
										name = L["Enable"],
										width = 'full',
										hidden = not E.Retail,
										get = function() return E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPower end,
										set = function(_, value) E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPower = value E:StaticPopup_Show('CONFIG_RL') end,
									},
									AltPowerred = {
										type = 'range',
										name = L["Red"],
										...
										hidden = not E.Retail,
										desc = L["This is how much the color will gain or lose this value"],
										disabled = function() return not E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPower end,
										get = function() return E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPowercolors.r end,
										set = function(_, value) E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPowercolors.r = value E:StaticPopup_Show('CONFIG_RL') end,
									},
									AltPowergreen = {
										type = 'range',
										name = L["Green"],
										...
										desc = L["This is how much the color will gain or lose this value"],
										disabled = function() return not E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPower end,
										get = function() return E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPowercolors.g end,
										set = function(_, value) E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPowercolors.g = value E:StaticPopup_Show('CONFIG_RL') end,
									},
									AltPowerblue = {
										type = 'range',
										name = L["Blue"],
										...
										desc = L["This is how much the color will gain or lose this value"],
										disabled = function() return not E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPower end,
										get = function() return E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPowercolors.b end,
										set = function(_, value) E.db.ElvUI_EltreumUI.unitframes.gradientmode.gradientAltPowercolors.b = value E:StaticPopup_Show('CONFIG_RL') end,
									},
								},
							},
							archeology = {
							...
							details = {
								...
								args = {
									...
									detailsembed = {
										...
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.skins.details end,
										get = function() return E.db.ElvUI_EltreumUI.skins.detailsembed end,
										set = function(_, value) E.db.ElvUI_EltreumUI.skins.detailsembed = value E:StaticPopup_Show('CONFIG_RL') end,
									},
									detailsembedcombat = {
										order = 411,
										type = 'toggle',
										...
										set = function(_, value) E.db.ElvUI_EltreumUI.skins.detailsembedooc = value E:StaticPopup_Show('CONFIG_RL') end,
									},
									detailsdelay = {
										type = 'range',
										...
										step = 1,
										width = "full",
										disabled = function() return not E.db.ElvUI_EltreumUI.skins.details or not E.db.ElvUI_EltreumUI.skins.detailsembed or not E.db.ElvUI_EltreumUI.skins.detailsembedooc end,
										get = function() return E.db.ElvUI_EltreumUI.skins.detailsdelay end,
										set = function(_, value) E.db.ElvUI_EltreumUI.skins.detailsdelay = value end,
									},
								},
							},
							other = {
								...
								args = {
									...
									simcskin = {
										...
										set = function(_, value) E.db.ElvUI_EltreumUI.skins.simulationcraft = value E:StaticPopup_Show('CONFIG_RL') end,
									},
									gap10 = {
										order = 1000,
										type = "description",
									...
									WarpDepleteskin = {
										...
										set = function(_, value) E.db.ElvUI_EltreumUI.skins.warpdeplete = value E:StaticPopup_Show('CONFIG_RL') end,
									},
								},
							},
						},
			...
			unitframes = {
				type = 'group',
				name = E:TextGradient(L["Unitframes"], 0.50, 0.70, 1, 0.67, 0.95, 1),
				order = 85,
				childGroups = "tab",
						...
						args = {
							enable = {
								...
								args = {
									...
									noclasstexture = {
										order = 3,
										name = L["Disable Class Textures"],
										type = "toggle",
										desc = L["Use only textures sets for specific frames and not class specific textures"],
										width = 'full',
										disabled = function() return (not E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.enable) or E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.classdetect end,
										get = function() return E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.noclasstexture end,
										set = function(_, value) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.noclasstexture = value end,
									},
								}
							},
							unitframes = {
								...
								args = {
									playertexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.playertexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall1 = {
										order = 15,
										type = 'execute',
									...
									castbartex = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.castbartexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall2 = {
										order = 17,
										type = 'execute',
									...
									targettexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.targettexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall3 = {
										order = 19,
										type = 'execute',
									...
									targettargettexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.targettargettexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall4 = {
										order = 21,
										type = 'execute',
									...
									targettargettargettexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.targettargettargettexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall5 = {
										order = 23,
										type = 'execute',
									...
									focustexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.focustexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall6 = {
										order = 25,
										type = 'execute',
									...
									pettexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.pettexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall7 = {
										order = 27,
										type = 'execute',
									...
									bosstexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.bosstexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall8 = {
										order = 29,
										type = 'execute',
							...
							classes = {
								...
								args = {
									...
									dktexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.deathknighttexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall9 = {
										order = 111,
										type = 'execute',
									...
									dhtexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.demonhuntertexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall10 = {
										order = 113,
										type = 'execute',
									...
									druidtexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.druidtexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall11 = {
										order = 115,
										type = 'execute',
									...
									huntertexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.huntertexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall12 = {
										order = 117,
										type = 'execute',
									...
									magetexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.magetexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall13 = {
										order = 119,
										type = 'execute',
									...
									monktexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.monktexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall14 = {
										order = 121,
										type = 'execute',
									...
									evokertexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.evokertexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall15 = {
										order = 123,
										type = 'execute',
									...
									paladintexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.paladintexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall16 = {
										order = 125,
										type = 'execute',
									...
									priesttexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.priesttexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall17 = {
										order = 127,
										type = 'execute',
									...
									roguetexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.roguetexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall18 = {
										order = 129,
										type = 'execute',
									...
									shamantexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.shamantexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall19 = {
										order = 131,
										type = 'execute',
									...
									warlocktexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.warlocktexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall20 = {
										order = 133,
										type = 'execute',
									...
									warriortexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.warriortexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall21 = {
										order = 135,
										type = 'execute',
									...
									npcfriendlytexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.npcfriendly = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall22 = {
										order = 137,
										type = 'execute',
									...
									npcneutraltexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.npcneutral = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall23 = {
										order = 139,
										type = 'execute',
									...
									npcunfriendlytexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.npcunfriendly = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall24 = {
										order = 141,
										type = 'execute',
									...
									npchostiletexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.npchostile = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall25 = {
										order = 143,
										type = 'execute',
									...
									tappedtexture = {
										...
										set = function(self,key) E.db.ElvUI_EltreumUI.unitframes.ufcustomtexture.tappedtexture = key ElvUI_EltreumUI:GradientColorTableUpdate() end,
									},
									applytoall26 = {
										order = 145,
										type = 'execute',

...
L["Immersion profile has been set."] = "Immersion配置文件已被设置。"
L["BigWigs profile has been set."] = "BigWigs配置文件已被设置。"
L["DBM profile has been set."] = "DBM配置文件已被设置。"
L["Details profile has been set."] = "Details配置文件已被设置。"
L["Dynamic Cam profile has been set."] = "Dynamic Cam配置文件已被设置。"
L["GladiusEx profile has been set."] = "GladiusEx配置文件已被设置。"
L["Method Raid Tools profile has been set."] = "Method Raid Tools配置文件已被设置。"
L["ProjectAzilroka profile has been set."] = "ProjectAzilroka配置文件已被设置。"
L["Questie profile has been set."] = "Questie配置文件已被设置。"
L["NameplateSCT profile has been set."] = "NameplateSCT配置文件已被设置。"
L["Floating Combat Text profile has been set."] = "Floating Combat Text配置文件已被设置。"
L["Gladius profile has been set."] = "Gladius配置文件已被设置。"
L["Gladdy profile has been set."] = "Gladdy配置文件已被设置。"
L["Area does not support waypoints"] = "区域不支持路径点"
L["Unsupported format"] = "不支持的格式"
L["Unsupported format or Area does not support waypoints"] = "不支持的格式 或 区域不支持路径点"
L["WARNING"] = "警告"
L["Make sure to install "] = "请确保安装"
L["Shadow and Light"] = true
L[" and "] = "和"
L["WindTools"] = "Wind工具箱"
L["AddOnSkins"] = true
L["ProjectAzilroka"] = true
L["This prompt will help you install "] = "这个提示会帮助你安装"
L[" and import its settings"] = "和导入它们的设定。"
L["Please read the instructions to avoid issues"] = "请阅读教程来避免出现问题"
L["Skip Install"] = "跳过安装"
L["Layouts"] = "布局"
L["Please select the role for your character, which will create a new profile.\nThis process can take a few seconds"] = "请选择你角色的职责，这会创建一个新的配置文件。\n这个过程会需要几秒钟时间。"
L["You can support the group with your class, if you select DPS/Tank then its recommended to click Alternative Frames after clicking DPS/Tank"] = "你可以用你的职业来帮助你的团队，如果你选择DPS/坦克那么推荐你在点完DPS/坦克后点击别的框架。"
L["Importance: "] = "重要程度:"
L["Very High"] = "非常高"
L["Fonts"] = "字体"
...
L["Import Details! profile with dual panels"] = "导入有两个面板的Details!配置文件"
L["You can right click the bottom right arrow to toggle the Details! Window"] = "你可以右键右下方的箭头来显示Details!的窗口"
L["Remember to swap the second window to Healing Done or Tiny Threat"] = "别忘了把第二个窗口设置为造成治疗或者仇恨显示"
L["Details is an advanced combat parser"] = "Details是目前最好用的伤害统计插件"
L["It has many plugins to choose from"] = "它有很多可选的小组件"
L["Boss Mods"] = "Boss模组"
L["Import DBM or Bigwigs profiles"] = "导入DBM或者Bigwigs配置文件"
L["DBM is not installed or enabled so BigWigs will be used"] = "DBM没有安装或者启用，所以Bigwigs将被使用"
L["BigWigs is not installed or enabled so DBM will be used"] = "Bigwigs没有安装或者启用，所以DBM将被使用"
L["DBM uses DBM English by Calanon as a voice pack"] = "DBM使用Calanon的英语模块作为默认语音配置"
L["Both DBM and BigWigs are not installed or enabled"] = "DBM和Bigwigs都没有安装或者启用"
L["Method Raid Tools"] = true
L["Import profiles for NameplateSCT or ElvUI Floating Combat Text"] = "导入NameplateSCT或者ElvUI Floating Combat Text的配置文件"
L["FCT profile will be used"] = "FCT配置文件将被使用"
L["NameplateSCT profile will be used"] = "NameplateSCT的配置文件将被使用"
L["Import "] = "导入"
L["settings configured for "] = "把设置配置于"
L[" is not installed or enabled"] = "没有被安装或者启用"
L["Import Dynamic Cam profile"] = "导入Dynamic Cam配置文件"
L["Welcome"] = "欢迎"
L["Join the Discord if you have any questions or issues (English Support)"] = "如果你有任何问题或者遇到任何困难的话，可以加入Discord获得帮助（英语帮助）"
L["Installation Complete"] = "安装完成"
L["Finished"] = "结束"
L["Questie is not installed or enabled"] = "Questie没有被安装或者启用"
L["Arenas"] = "竞技场"
L["Abbreviates the unit name once it goes over 16 characters, made by Azilroka"] = "当角色昵称超过16个字符时自动缩短，由Azilroka制作"
L["updated to "] = "已更新至"
L["Layout has been set."] = "布局已被设置"
L["General Layout has been set."] = "基础布局已被设置"
L["The alternative layout was made for the Eltruism DPS/Tank profile, please switch to it to use it"] = "另一份布局是Eltruism DPS/坦克的配置文件，请切换来使用它"
L["The original layout was made for the Eltruism DPS/Tank profile, please switch to it to use it"] = "原始布局是Eltruism DPS/坦克的配置文件，请切换来使用它"
L["You need to be using an Eltruism profile in order to use this function"] = "你需要使用一份Eltruism配置文件来使用这个功能"
...
L["Enable"] = "启用"
L["Cursor"] = "鼠标指针"
L["Change the size of the World of Warcraft Cursor"] = "改变魔兽世界鼠标指针的大小"
L["Select a size"] = "选择大小"
L["Choose this size"] = "选择这个大小"
L["Autodetect"] = "自动检测"
L["Add GCD, Cast and Combat indicator rings to the cursor"] = "将GCD，施法和战斗检测圆环加入到鼠标指针上"
L["Enable cooldown tracking"] = "启用冷却追踪"
L["Add a cooldown icon when trying to use skills that are on cooldown, and a cooldown flash when they are ready"] = "当试图使用正在冷却的技能时，增加一个冷却图标，当技能准备好时，增加一个冷却闪光"
L["Enable cursor rings for Casts, GCD and Combat"] = "启用鼠标的GCD，施法，战斗检测圆环"
L["Add a rings around the mouse cursor for GCD, casts and combat"] = "将GCD，施法和战斗检测圆环加入到鼠标指针上"

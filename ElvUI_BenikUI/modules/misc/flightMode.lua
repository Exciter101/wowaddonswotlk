...
function mod:Initialize()
	...
	-- Top frame
	mod.FlightMode.top = CreateFrame('Frame', nil, mod.FlightMode, 'BackdropTemplate')
	...
	-- Location frame
	mod.FlightMode.top.location = CreateFrame('Frame', 'FlightModeLocation', mod.FlightMode.top, 'BackdropTemplate')
	...
	-- Coords X frame
	mod.FlightMode.top.location.x = CreateFrame('Frame', nil, mod.FlightMode.top.location, 'BackdropTemplate')
	...
	-- Coords Y frame
	mod.FlightMode.top.location.y = CreateFrame('Frame', nil, mod.FlightMode.top.location, 'BackdropTemplate')
	...
	-- Bottom frame
	mod.FlightMode.bottom = CreateFrame("Frame", nil, mod.FlightMode, 'BackdropTemplate')
	...
	mod.FlightMode.bottom.info:Point("LEFT", mod.FlightMode.bottom, "LEFT", 10, 0)
	...
	-- Time flying
	mod.FlightMode.bottom.timeFlying = CreateFrame('Frame', nil, mod.FlightMode.bottom, 'BackdropTemplate')
	...
	-- fps
	mod.FlightMode.bottom.fps = CreateFrame('Frame', nil, mod.FlightMode.bottom, 'BackdropTemplate')
